...
public class TencentApiController {
    ...
    public ApiResponse getDescribeDomainList(@RequestBody UserInfo userInfo ) {
        log.info("获取所有解析域名"+userInfo);
        try{
            ...
            Credential cred = new Credential(userInfo.getId(), userInfo.getKey());
...
//            System.out.println(AbstractModel.toJsonString(resp));
            return ApiResponse.success(Arrays.asList(resp));
